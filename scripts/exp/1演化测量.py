...
# 定义结果文件夹
result_folder = root_folder + "\\2_FishNet_TFData_r"
# 执行校准（默认耗时较长）
clb.calibrate(
    # starts_num=1,
    # chunks_per_start=1,
...
# 定义结果文件夹
result_folder = root_folder + "\\6_evo_r"
# 计算理论结果
_ = evo.simulate(
    cr=cr_center,
    ci=ci_center,
...
# 定义结果文件夹
result_folder = root_folder + "\\5_M+_r_8fb_sweep"
# 创建仅包含反馈通道的波形
...
# 定义结果文件夹
result_folder = root_folder + "\\6_M+_r_1st_sweep"
# 创建仅包含反馈通道的波形
...
# 定义结果文件夹
result_folder = root_folder + "\\9_M-_l_8fb_sweep"
# 创建仅包含反馈通道的波形
...
# 定义结果文件夹
result_folder = root_folder + "\\10_M-_l_1st_sweep"
# 创建仅包含反馈通道的波形
...
# 定义结果文件夹
result_folder = root_folder + "\\11_M-_R_1st_sweep"
# 创建仅包含反馈通道的波形
...
# 定义结果文件夹
result_folder = root_folder + "\\12_M-_R_8fb_sweep"
# 创建仅包含反馈通道的波形
...
# 定义结果文件夹
result_folder = root_folder + "\\13_X_R_bg_sweep"
# 创建仅包含反馈通道的波形
...
# 定义结果文件夹
result_folder = root_folder + "\\14_X_L_bg_sweep"
# 创建仅包含反馈通道的波形
